...
$.fn.tabs.defaults.onContextMenu = function(e,title,index){
	e.preventDefault();
	divTabs = $(this);
	var menuDiv = $('<div style="width:100px;"><div id="refresh" data-options="iconCls:\'icon-reload\'">刷新</div><div class="menu-sep"></div><div id="close" data-options="iconCls:\'icon-no\'">关闭本页</div><div id="closeright" data-options="iconCls:\'icon-no\'">关闭右侧</div><div id="closeother" data-options="iconCls:\'icon-no\'">关闭其他</div><div id="closeall" data-options="iconCls:\'icon-no\'">全部关闭</div>').appendTo("body");
	menuTabs = menuDiv.menu({
		onClick:function(item){
