...
public class DepartmentController {
    ...
    @ResponseBody
    public Response<List<SystemDepartment>> departmentListPage(){
        return Response.<List<SystemDepartment>>getInstance().setData(systemDepartmentService.getDepartment());
    }
}
